<?php
	...
	$mail->Username = 'impact.alternative.model@gmail.com'; //usuário do smtp (email cadastrado no servidor)
	...
	$mail->Subject = 'You were invited to collaborate in an iMap session'; //assunto
	$mail->Body    = '<h1>iMap</h1><br>This message is an invitation to join an iMap session.'; //Se o formato da mensagem for HTML você poderá utilizar as tags do HTML no corpo do e-mail
